...
RUN wget "https://github.com/bnb-chain/bsc/releases/download/v1.5.11/geth_linux"
RUN mv geth_linux geth
RUN chmod -v u+x geth
RUN wget "https://github.com/bnb-chain/bsc/releases/download/v1.5.11/mainnet.zip"
RUN unzip mainnet.zip
RUN mv config.toml config-mainnet.toml
RUN mv genesis.json genesis-mainnet.json
RUN wget "https://github.com/bnb-chain/bsc/releases/download/v1.5.11/testnet.zip"
